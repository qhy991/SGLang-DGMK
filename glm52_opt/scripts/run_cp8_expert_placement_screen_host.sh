...
# Exact-input CP8/EP8 identity-vs-balanced expert-placement screen.
...
BALANCED_MAP=$REPO/glm52_opt/glm52_100k_x11_static_expert_map.json
...
OUT=$EVIDENCE/expert_identity_vs_balanced_$STAMP
mkdir -p "$OUT"
...
run_arm() {
  ...
  env \
    ...
    GLM52_ROUTER_STATIC_PLACEMENT_FUSION="$fusion" \
...
run_arm identity '' 0
run_arm balanced "$BALANCED_MAP" 1
echo "[DONE] $OUT"
