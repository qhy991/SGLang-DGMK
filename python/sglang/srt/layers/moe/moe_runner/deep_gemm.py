...
def _varlen_deep_gemm_silu_mul_quant(
    ...
    # The B300 candidate is default-off and exact-ABI only. Automatic
    # dispatch rejects every unsupported semantic field before allocating or
    # launching, then leaves the stock route below authoritative.
