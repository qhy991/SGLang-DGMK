...
class Envs:
    ...
    # GLM-5.2 fused-QKV-A prefill projection: opt into the same layer-private
    # fixed-N/K specialization only for exact packed UE8M0 EXTEND M4096.
    # Default remains off until checkpoint-backed TP8/DP8/EP8 acceptance.
    SGLANG_OPT_GLM52_FUSED_QKV_A_PREFILL_DIRECT_NK = EnvBool(False)
