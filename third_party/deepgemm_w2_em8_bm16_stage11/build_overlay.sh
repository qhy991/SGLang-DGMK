...
readonly BUILD_ID="glm52-task26-em8-bm16-stage11-v3:sgl-deep-gemm-0.1.4.post1@${BASE_COMMIT}:sm100:e32:m1024:k2048:n6144:expected-m8:bm16:stages11:pdl1:sms148:packed-ue8m0:no-recipe:no-overlap"
...
OVERLAY_ROOT="${REPO_ROOT}/build/deepgemm-w2-em8-bm16-stage11-v3-overlays"
OVERLAY_DIR="${OVERLAY_ROOT}/${BUILD_KEY}"
MANIFEST_PATH="${OVERLAY_DIR}/manifest.json"
STOCK_PACKAGE="${OVERLAY_DIR}/stock/site/deep_gemm"
CANDIDATE_PACKAGE="${OVERLAY_DIR}/candidate/site/deep_gemm_glm52_w2_em8_bm16_stage11_v3"
BUILD_TMP_PARENT="${REPO_ROOT}/build/deepgemm-w2-em8-bm16-stage11-v3-tmp"
...
cp -a "${BUILD_TMP}/candidate-source/build/deep_gemm" \
  "${STAGED_OVERLAY}/candidate/site/deep_gemm_glm52_w2_em8_bm16_stage11_v3"
...
"$HARNESS_PYTHON" "$MANIFEST_TOOL" verify \
  ...
  --check-env \
  --check-provenance
echo "Exact-post1 stock and W2/em8/BM16/stage11 candidate ready: $MANIFEST_PATH"
