...
def write_manifest(args: argparse.Namespace) -> None:
    ...
    candidate_package_artifact = (
        artifact_root / "candidate/site/deep_gemm_glm52_w2_em8_bm16_stage11_v3"
    )
    stock_package_final = final_root / "stock/site/deep_gemm"
    candidate_package_final = (
        final_root / "candidate/site/deep_gemm_glm52_w2_em8_bm16_stage11_v3"
    )
...
def _verify_package(
    ...
    *,
    ...
    expected_relative = (
        ...
        if role == "stock"
        else Path("candidate/site/deep_gemm_glm52_w2_em8_bm16_stage11_v3")
    )
...
def verify_manifest(args: argparse.Namespace) -> None:
    ...
    _assert_equal(manifest["schema_version"], 4, "schema_version")
    ...
    if args.check_provenance:
        ...
        _assert_equal(provenance["schema_version"], 3, "provenance.schema_version")
        _assert_equal(
